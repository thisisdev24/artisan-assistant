            ...
            <header className="bg-emerald-900 text-black py-20 overflow-hidden">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <rect x="0" y="0" width="520" height="360" rx="18" fill="#062c28" />
                            <g transform="translate(60,40)" fill="none" stroke="#fff" strokeWidth="2">
                                <rect x="20" y="10" rx="8" width="180" height="220" fill="#fff2e8" stroke="none" />
                                <rect x="240" y="50" rx="8" width="180" height="200" fill="#fff9f4" stroke="none" />
                            </g>
                            {/* two simple person shapes */}
                            <g transform="translate(120,60)">
                                <circle cx="40" cy="40" r="22" fill="#f97316" />
                                <rect x="12" y="70" width="56" height="60" rx="12" fill="#fff" />
                            </g>
                            <g transform="translate(320,100)">
                                <circle cx="40" cy="32" r="20" fill="#0f766e" />
                                <rect x="12" y="60" width="56" height="60" rx="12" fill="#fff" />
                            </g>
                        </svg>
                    </motion.div>
                </motion.div>
            ...
            <main className="max-w-7xl mx-auto px-6 lg:px-8 -mt-12">
                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Interested in our product? Speak with a member of our sales team to get a demo or
                                    pricing details.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 flex-1">
                            ...
                            <a href="tel:+18884827768" className="mt-3 inline-block text-lg font-semibold text-emerald-900 hover:text-emerald-700 transition-colors">
                                +1 888 482 7768
                            </a>
                            <div className="mt-4">
                                <a href="#" className="text-sm text-amber-600 underline hover:text-amber-700 transition-colors">View all global numbers</a>
                            </div>
                        </div>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-gray-900">Contact Customer Support</h3>
                                <p className="text-sm text-gray-500 mt-1">
                                    Need help? Our support team is available to troubleshoot and guide you through any issues.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 flex-1">
                            <p className="text-sm text-gray-600">
                                Open a support ticket or start a live chat for immediate assistance.
                            </p>
                            <div className="mt-4">
                                <motion.a
                                    href="#"
                        ...
                        <div className="mt-6 flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-700 font-medium">Mon–Fri 8am–8pm</span>
                        </div>
                    </motion.article>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mt-2">Get pricing guides, ROI calculators and case studies.</p>
                    </motion.div>
                    <motion.div
                        className="bg-white rounded-2xl p-6 shadow ring-1 ring-gray-100 transition-all duration-300 hover:shadow-lg hover:scale-105"
                        variants={itemVariants}
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mt-2">Browse support docs and developer guides.</p>
                    </motion.div>
                    <motion.div
                        className="bg-white rounded-2xl p-6 shadow ring-1 ring-gray-100 transition-all duration-300 hover:shadow-lg hover:scale-105"
                        variants={itemVariants}
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mt-2">Learn about partnership opportunities and integrations.</p>
                    </motion.div>
                </motion.div>
            </main>
                ...
                >
                    <div className="relative">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                        >
                            <span className="w-10 h-10 rounded-full bg-amber-500 text-white flex items-center justify-center font-bold animate-pulse">AI</span>
                            <span className="text-sm text-gray-700">Want to get in touch? I’m an AI chatbot here to help</span>
                        </motion.button>
                        <motion.button
