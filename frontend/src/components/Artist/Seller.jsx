...
const Seller = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center py-16 px-6 select-none">
      <h1 className="text-4xl font-bold mb-10 text-gray-800">
        Seller Dashboard
      </h1>

      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-6xl lg:max-w-7xl">
        {/* Card 1: Add New Product */}
        <div className="bg-white shadow-lg rounded-2xl p-8 flex flex-col justify-between items-center text-center hover:shadow-xl transition-all duration-300">
